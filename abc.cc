...
main(int argc, char* argv[])
{
    ...
    double maxRandomLossDB = 800;
    double minSpeedMetersPerSecond = 2;
    double maxSpeedMetersPerSecond = 16;
    std::string adrType = "ns3::AdrComponent";
    std::string tclFile = "/home/yusuf/ns-3-dev/scratch/dilara.tcl";
    ...
    cmd.AddValue("tclFile", "The name of the Tcl file with mobility trace", tclFile);
    cmd.Parse(argc, argv);
    ...
    AnimationInterface anim("test3.xml");
    Simulator::Run();
    Simulator::Destroy();
